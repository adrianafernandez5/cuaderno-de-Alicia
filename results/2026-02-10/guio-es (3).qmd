...
# Con el comando "wc" (word count) conoceremos el número de líneas. 
# El número debe coincidir en ambos archivos (lectura 1 y lectura 2). 
#En el terminal de Bash usé: "gunzip -c DRR025089_1.fastq.gz | wc -l" y
# "gunzip -c DRR025089_2.fastq.gz | wc -l" respectivamente. En ambos casos dio 1646728.
:::
...
#En mi caso he guardado los archivos descargados en data. Esto es mejor porque carpeta
# es ignorada por git.
- ¿Cómo podrías guardar los mensajes de `wget` en un archivo?
# wget sirve para instalar programas.
- ¿De cuántas secuencias diferentes se compone este genoma de referencia?
#Para visualizarlo primero pongo "less -c referencia.fa" esto último es el nombre del archivo.
# Pero para saber el número de secuencias utilizo wc, de esta forma: "less -c referencia.fa | wc -l". En este caso son 167052.
:::
...
#Hemos usado -i, -o, -I, -O, --merge\, --merge_out
