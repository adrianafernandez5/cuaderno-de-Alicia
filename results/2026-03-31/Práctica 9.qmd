...
#- 1 Gorila
#- Homo heidelbergensis (de hace 400.000 años)
...
help(add.scale.bar)
# Esta función añade una barra horizontal que indica la escala de las longitudes de las ramas a la representación gráfica de un árbol filogenético en el dispositivo gráfico actual.

help(axisPhylo)
#Esta función añade un eje escalado al lado de un gráfico filogenético.
...
#CONCLUSIÓN: Las muestras arqueológicas deben de haber dejado de acumular mutaciones hace tiempo. Homo heldeibergensis es el que mejor se ve, su rama se queda más atrás que otros. Lo que no es normal que los denisovanos tengan una rama tan larga.
